...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9455200d-d238-4ed3-a7f8-709467d70fab
```

> `9455200d-d238-4ed3-a7f8-709467d70fab` is the password of the certificate, you can change it to any password you want.
